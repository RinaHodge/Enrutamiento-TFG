...
def generar_dataset():
    ...
    with (open('Abilene_delay1.csv', mode='w', newline='') as file_csv
            ...
            for probabilidad in range (1, 3):  # 1 para 10% y 2 para aleatoria
                ...
                for delay in range (1, 3):  # 1 para 1ms y 2 para aleatoria
                    ...
                    for iteracion in range(vueltas):
                        ...
                        rutas, exito = enrutar(grafo, trafico, k=36, tipo_enrutamiento=2)  # Enrutar con la configuración actual del grafo. El enrutamiento se hace con el delay
                        ...
                        if exito:
                            ...
                            print(f"TA óptimo global para esta configuración: {nodo_TA_optimo_global}")
